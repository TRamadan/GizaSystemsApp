...
export class FooterComponent implements OnInit , AfterViewInit {
  ...
  animateFooter(): void {
    ...
    .to(this.socialLinks.nativeElement, {
      duration: 0.6,
      opacity: 1,
      y: 0,
      ease: "power2.out"
    ...
    .to(this.copyright.nativeElement, {
      duration: 0.5,
      opacity: 1,
      y: 0,
      ease: "power2.out"
  ...
  addHoverAnimations(): void {
    ...
    const socialIcons = this.footerContainer.nativeElement.querySelectorAll('.social-icon');
    ...
    const footerLinks = this.footerContainer.nativeElement.querySelectorAll('.footer-links a');
    ...
    const subsidiaryItems = this.footerContainer.nativeElement.querySelectorAll('.subsidiary-item');
  ...
  onSubscribe(): void {
    if (this.newsletterForm.valid) {
      ...
      setTimeout(() => {
        ...
        // Success animation
        const button = this.footerContainer.nativeElement.querySelector('.newsletter-btn');
        gsap.to(button, {
          duration: 0.2,
          scale: 1.1,
          ease: "power2.out",
      ...
      const inputGroup = this.footerContainer.nativeElement.querySelector('.input-group');
      gsap.to(inputGroup, {
        duration: 0.1,
        x: -5,
        ease: "power2.inOut",
